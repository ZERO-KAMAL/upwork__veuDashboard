          ...
          <b-row>
            ...
            >
              <div class="d-flex align-items-center justify-content-end">
                ...
                >
                  <span class="text-nowrap">Add New AR Network</span>
                </b-button>
              </div>
            </b-col>
          </b-row>
...
import ArnetworksListFilters from './ArnetworksListFilters.vue'
import useArnetworkList from './useArnetworkList'
import ArnetworksListAddNew from './ArnetworksListAddNew.vue'

export default {
  components: {
    ArnetworksListFilters,
    ArnetworksListAddNew,
